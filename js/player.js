...
if (navigator.userAgent.match(/(iPhone|iPod|Android|ios)/i)) $("#wenkmPlayer").hide();
    ...
    // apiurl = "https://www.terrancy.com/music/netease.php";
    ...
    var cicleTime = null;
    $cover.html('<img src="https://q.qlogo.cn/headimg_dl?bs=qq&dst_uin=16511660&src_uin=xiaocp.com&fid=blog&spec=100">');
    $songName.html('<a style="color:#f00">初始化失败</a>');
    $songFrom.html('<a style="color:#f00">By：Ape</a>');
    $songFrom1.html('<a style="color:#f00">阿佩</a>');
    ...
    var wenkmMedia = {
            ...
            getInfos: function(a) {
                ...
                // audio.src = apiurl+"?mode=net_mp3&parm="+id;
                audio.src = "http://www.terrancy.com/music/netease.php?mode=net_mp3&parm="+id;
                ...
                c.onload = function() {
                    ...
                    $.ajax({
                        ...
                        // url: apiurl + "?mode=image_info&parm=" + id,
                        type: "GET",
                        dataType: "script",
                        success: function() {
                            $(".myhk_pjax_loading_frame,.myhk_pjax_loading").hide();
                ...
                c.error = function() {
                    ...
                    c.src = "https://q.qlogo.cn/headimg_dl?bs=qq&dst_uin=16511660&src_uin=xiaocp.com&fid=blog&spec=100";
                    setTimeout(function() {
        ...
        wenkmLrc = {
            load: function() {
                ...
                $.ajax({
                    ...
                    dataType: "script",
                    success: function() {
                      // console.log(apiurl + "?mode=net_lrc&parm=" + id);
                      // console.log(cont);
